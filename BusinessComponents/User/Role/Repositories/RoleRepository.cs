...
namespace Victornet.Common.Repositories
{
    ...
    public class RoleRepository : Repository<Role>
    {
        ...
        {
            var sql = Sql.Builder;
            sql.Append("Update tn_Roles set FriendlyRoleName = @0,IsPublic = @1,Description = @2, RoleImage = @3, IsEnabled = @4  where RoleName = @5", role.FriendlyRoleName, role.IsPublic, role.Description, role.RoleImage, role.IsEnabled, role.RoleName);
