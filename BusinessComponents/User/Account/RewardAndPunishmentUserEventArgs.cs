...
namespace Victornet.Common
{
    ...
    /// 用户更改积分的参数
    /// </summary>
    public class RewardAndPunishmentUserEventArgs : CommonEventArgs
    {
        /// <summary>
        /// 更新积分
        /// </summary>
        ...
        public RewardAndPunishmentUserEventArgs(int experiencePoints, int reputationPoints, int tradePoints, int tradePoints2, int tradePoints3, int tradePoints4)
        ...
        public RewardAndPunishmentUserEventArgs(int experiencePoints, int reputationPoints, int tradePoints, int tradePoints2, int tradePoints3, int tradePoints4, string eventOperationType)
