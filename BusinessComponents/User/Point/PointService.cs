...
//<email>zhengw@Victornet.com</email>
...
namespace Victornet.Common
{
    ...
    public class PointService
    {
        ...
        public void Reward(long userId, int experiencePoints, int reputationPoints, int tradePoints, string description)
        {
            ...
            //3、生成操作日志            
            OperationLogService logService = Victornet.DIContainer.Resolve<OperationLogService>();
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        private string TrackPointRecordCacheKey(long userId)
        {
