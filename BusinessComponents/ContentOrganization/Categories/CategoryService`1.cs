...
namespace Victornet.Common
{
    ...
    public class CategoryService<T> where T : Category
    {
        ...
        public bool Delete(long categoryId)
        {
            ...
            Victornet.Caching.RealTimeCacheHelper cacheHelper = EntityData.ForType(typeof(T)).RealTimeCacheHelper;
        ...
        {
			return categoryRepository.GetOwnerRootCategories(ownerId, tenantTypeId);
        }
        ...
        public void ClearItemsFromCategory(T category)
        {
            //获取关联的Category
            if (category == null)
