...
namespace Victornet.Common
{
    ...
    public class ReminderService
    {
        ...
        public ISettingsManager<ReminderSettings> reminderSettingsManager = DIContainer.Resolve<ISettingsManager<ReminderSettings>>();
        ...
        public UserReminderSettings GetUserReminderSettings(long userId, int reminderModeId, int reminderInfoTypeId)
        {
            ...
            if (!allUserReminderSettings.ContainsKey(reminderModeId.ToString()))
                return null;
            if (allUserReminderSettings[reminderModeId.ToString()] == null)
                return null;
