...
namespace Victornet.UI
{
    ...
    public class ThemedViewEngine : BuildManagerViewEngine
    {
        ...
        protected virtual void GetPresentAreaKeyAndIsApplicationFromThemedAttribute(ControllerContext controllerContext, out string presentAreaKey, out bool isApplication)
        {
