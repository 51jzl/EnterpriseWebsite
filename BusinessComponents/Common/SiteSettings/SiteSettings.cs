...
namespace Victornet.Common
{
    ...
    public class SiteSettings : IEntity
    {
        ...
        string defaultSiteName = "ShareCode";
        /// <summary>
        /// 站点名称
        /// </summary>
        ...
        string defaultSiteDescription = "基于asp.net mvc 最强大ShareCode";
        /// <summary>
        /// 站点描述
        /// </summary>
        ...
        string searchMetaDescription = "ShareCode 是分享代码的网站。它采用了业内领先的技术体系架构、隐私保护功能、用户评价体系、优异的缓存技术、全文检索技术。可以承载千万级的数据，具备优异的扩展性并提供丰富的API，方便用户进行定制开发或者二次开发。";
        /// <summary>
        /// 页面头信息的description
        /// </summary>
        ...
        string searchMetaKeyWords = "ShareCode、分享代码";
        /// <summary>
        /// 页面头信息的KeyWord
        /// </summary>
