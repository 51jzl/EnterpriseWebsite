...
namespace Victornet.Common
{
    ...
    public class OwnerDataService
    {
        ...
        public long GetTotalCount(IEnumerable<string> dataKeys, long ownerId)
        {
            ...
            long totalCount = 0;
            Dictionary<string, long> dictionary = Gets(ownerId, dataKeys);
        ...
        /// <returns></returns>
        public Dictionary<string, long> Gets(long ownerId, IEnumerable<string> dataKeys)
        {
            return ownerDataRepository.Gets(ownerId, tenantTypeId, dataKeys);
        }
    }
}
