...
namespace WZ.WebSite.Areas.Manage.Controllers
{
    public class DefaultController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToLocal(Url.Action("Index", "Admin"));
        ...
        // GET: Manage/Default/Details/5
        public ActionResult Details(int id)
        {
            return View();
        }

        // GET: Manage/Default/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: Manage/Default/Create
        [HttpPost]
        ...
        // GET: Manage/Default/Edit/5
        public ActionResult Edit(int id)
        {
            return View();
        }

        // POST: Manage/Default/Edit/5
        [HttpPost]
        ...
        // GET: Manage/Default/Delete/5
        public ActionResult Delete(int id)
        {
            return View();
        }

        // POST: Manage/Default/Delete/5
        [HttpPost]
